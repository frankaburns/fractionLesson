package com.fabo.fractionlesson.view;
...
import com.fabo.fractionlesson.R;
import com.fabo.fractionlesson.databinding.FragmentFractionLessonBinding;
import com.fabo.fractionlesson.domain.BasicFractionalMath;
import com.fabo.fractionlesson.domain.Fraction;
import com.fabo.fractionlesson.domain.FractionProblemGenerator;
 ...
 */
public class FragmentFractionLesson extends Fragment {
    ...
    // Working variables
    BasicFractionalMath problem = null;
    private FractionProblemGenerator pg = null;

    private FragmentFractionLessonBinding fragmentLessonBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentLessonBinding = FragmentFractionLessonBinding.inflate(inflater,container,false);
        ...
        if (getArguments() != null){
            ...
            switch (function) {
                case 0:
                    pg.setLessonFunction(BasicFractionalMath.ADD);
                    functionStr = "+ ";
                    break;
                case 1:
                    pg.setLessonFunction(BasicFractionalMath.SUB);
                    functionStr = "- ";
                    break;
                case 2:
                    pg.setLessonFunction(BasicFractionalMath.MUL);
                    functionStr = "x ";
                    break;
                case 3:
                    pg.setLessonFunction(BasicFractionalMath.DIV);
                    functionStr = "/ ";
                    break;
            }
        ...
        String numerator = "" + problem.getOperand1().toString();
        fragmentLessonBinding.textViewNumerator.setText(numerator);
        String denominator = functionStr + problem.getOperand2().toString();
        ...
        fragmentLessonBinding.btnslash.setOnClickListener(v -> onNumberClicked("/"));
        ...
        assert fragmentLessonBinding.btnlcm != null;
        fragmentLessonBinding.btnlcm.setOnClickListener(v -> {

            String blank = "";
            fragmentLessonBinding.textViewComment.setText(blank);
            String lcd = Integer.toString(LCDCalculator.findLCM(problem.getOperand1().getDenominator(), problem.getOperand2().getDenominator()));;
            fragmentLessonBinding.textViewComment.setText(lcd);
        });

        assert fragmentLessonBinding.btngcd != null;
        fragmentLessonBinding.btngcd.setOnClickListener(v -> {
            Fraction fraction = new Fraction(number);
            Fraction gcd = FractionReducer.reduceFraction(fraction.getNumerator(), fraction.getDenominator());

            // fragmentLessonBinding.textViewComment.setText(blank);
            String blank = "";
            fragmentLessonBinding.textViewComment.setText(blank);

            String lcm = Integer.toString(fraction.getNumerator() / gcd.getNumerator());
            fragmentLessonBinding.textViewComment.setText(lcm);
        });
    ...
    public void problemSolution(){
        ...
        if (problem != null && number != null) {
            ...
            Fraction ans = new Fraction(number);
            if (!ans.equals(problem.doTheMath())) {
                if (wrong < 3) {
                    String msg;
                    wrong++;
        ...
        if (problem == null) {
            ...
            Navigation.findNavController(this.fragmentLessonBinding.getRoot()).navigate(
                    R.id.action_fragmentFractionLesson_to_fragmentResult,
                    bundle,
